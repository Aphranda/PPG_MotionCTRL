...
function SmStep0() 											// 状态0处理
	delay(10)
	rtn = allBtnIsPress(0.2) 										// 短按一秒
	if rtn == "Pressed" or gTestStep == 2 then									
		gSMStep = 1												// 跳转到下一个状态
...
function SmStep3() 	// 状态3处理
	delay(10)
	scpi_led_excution("CONF:LED GREEN")
    gSMStep = 4	// 跳转到下一个状态
end

function SmStep4() 	// 状态4处理
	rtn = allBtnIsPress(0.3)  // 短按0.3s
	if rtn == "Pressed" or gTestStep == 3 then
